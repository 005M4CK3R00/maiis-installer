	...
	def main():
		...
		if ver == "y" or ver == "Y":
			...
			if back_restore == "y" or back_restore == "Y" :
				...
				os.system('cp alarm.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp datab.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp pass.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp pc.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp wp.txt /sdcard/Androide/data/com.maiis.main.files/')
				# os.system('cp rec.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp usp.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp database.txt /sdcard/Androide/data/com.maiis.main.files/')
				os.system('cp find.txt /sdcard/Androide/data/com.maiis.main.files/')
				...
				if maiis_install_agan == 'n':
					...
					os.system('cp kill.py /sdcard/Androide/data/com.maiis.main.files/')
					os.system('cp alarm.mp3 /sdcard/Androide/data/com.maiis.main.files/')
					
					os.system('cp pac.py /sdcard/Androide/data/com.maiis.main.files/')
